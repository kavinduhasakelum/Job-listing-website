      ...
      <div className="flex flex-col gap-6 ">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-justify">
            ...
            Architecto id aliquam expedita dicta adipisci nihil, voluptatum,
            eaque veritatis accusantium perferendis asperiores quibusdam ducimus
            fugiat facilis, porro pariatur iste quos delectus.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
            ...
            {[...Array(4)].map((_, i) => (
                <div className="flex flex-col gap-2 rounded-2xl hover:bg-gray-100 p-4 w-[300px]" key={i}>
                    <p className="font-semibold">Senior Software Engineer</p>
                    <p className="font-light text-gray-400 text-sm">Innovate Solutions Ltd.</p>
                </div>
            ))}
        </div>
      </div>
